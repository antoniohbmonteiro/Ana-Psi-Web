export const sitePublicProfile = {
  professionalName: "Ana Paula Boaventura de Moura",
  displayName: "Ana Paula Boaventura",
  shortBrand: "Ana | Psicologia",
  crp: "04/84622",
...
export const sitePublicLanding = {
  hero: {
    title: "Cuide da sua",
    ...
    badgePrefix: "Psicóloga Online (Ana)",
  ...
  about: {
    ...
    title: "Olá, sou a Ana",
    body:
      "Psicóloga com registro CRP 04/84622, com atuação clínica voltada para adultos e adolescentes.\n\nAcredito que cada pessoa tem sua própria história e ritmo. Meu papel é oferecer um espaço de **acolhimento, escuta ativa e confiança**, onde você possa se expressar livremente.\n\nMinha abordagem é humanista e busca favorecer **autoconhecimento, compreensão emocional e construção de recursos** para lidar com os desafios da vida.",
  ...
  specialties: {
    ...
    subtitle:
      "Trabalho com diferentes demandas emocionais, sempre respeitando sua individualidade.",
    items: [
      {
        title: "Ansiedade",
        description:
          "Aprenda a lidar com pensamentos acelerados e preocupações excessivas.",
        icon: "brain"
      },
      {
  ...
  process: {
    ...
    subtitle:
      "Um processo simples e acolhedor do primeiro contato ao acompanhamento.",
    items: [
      {
        number: "01",
      ...
      },
      {
        ...
        title: "Agendamento",
        description:
          "Escolhemos juntas o melhor horário para sua rotina. Flexibilidade é importante.",
        icon: "calendar"
      },
      {
        number: "03",
        ...
        description:
          "Encontros de 50 minutos por videochamada, em ambiente seguro e confidencial.",
        icon: "video"
      },
      {
        number: "04",
  ...
  faq: {
    ...
    subtitle:
      "Esclareci as principais dúvidas, mas fique à vontade para perguntar o que quiser.",
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "Sim. O ideal é avisar com antecedência para que possamos reorganizar o horário."
      },
      {
      ...
      },
      {
        ...
        answer:
          "Os valores e formas de pagamento podem ser informados diretamente no WhatsApp."
      }
    ]
  },
  finalCta: {
    ...
    responseTimeText: "Respondo em até 24 horas",
    imageSrc: "/images/landing/final-cta-room.jpg"
  },
  footer: {
    description:
      "Um espaço de acolhimento, escuta e cuidado para sua saúde mental.",
